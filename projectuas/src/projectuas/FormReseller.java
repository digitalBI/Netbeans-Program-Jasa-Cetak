 ...
 * @author SiBee
 */
public final class FormReseller extends javax.swing.JFrame {

   private final DefaultTableModel model;
    public FormReseller() throws SQLException {
        initComponents();
        AutoNumber();
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
       try {
           ...
           Logger.getLogger(FormReseller.class.getName()).log(Level.SEVERE, null, ex);
       }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new FormReseller().setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(FormReseller.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
