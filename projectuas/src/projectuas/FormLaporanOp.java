 ...
 * @author SiBee
 */
public final class FormLaporanOp extends javax.swing.JFrame {

   
    public FormLaporanOp() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormLaporanOp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormLaporanOp().setVisible(true);
            }
        });
    }
